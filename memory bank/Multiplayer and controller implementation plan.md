...
Access the game at http://localhost:3000/client/index.html.
...
Update index.html to support multiple viewports:
html
...
Update main.js for Split Screens:
...
Assign Gamepads:
Map gamepad index to player (e.g., gamepad 0 to Player 1, gamepad 1 to Player 2).
...
Deploy server.js to a cloud platform like Heroku:
bash
